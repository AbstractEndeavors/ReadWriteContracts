...
def ifInJsWLs(ls,js,ls2):
    ...
    return ls2
def getgetAllJs():
    return json.loads(reader('dataFold/allJs.json'))
def getlast_api():
    return reader('dataFold/last_api.txt')
def getprevInputs():
    return json.loads(reader('dataFold/prevInputs.json'))
def getrpcListNew():
    return json.loads(reader('dataFold/rpcListNew.json'))
def getrpcValues():
